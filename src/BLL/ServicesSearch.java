...
public class ServicesSearch {
    ...
    public Map<String, List<String>> getBluetoothDevices() {
        /**
         * Find service on bluetooth device Note: In following line you can use
         * one service at a time. I'm new to bluetooth programming it might me
         * wrong perception. UUID[] searchUuidSet = new
         * UUID[]{OBEX_FILE_TRANSGER_PROFILE};
         *
         * CORRECT: UUID[] searchUuidSet = new
         * UUID[]{OBEX_FILE_TRANSGER_PROFILE}; WRONG: UUID[] searchUuidSet = new
